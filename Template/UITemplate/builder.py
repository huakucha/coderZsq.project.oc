...
if subview == "Yes":
   builder("SubviewTemplate.h", "View.h", "Yes")
   builder("SubviewTemplate.m", "View.m", "Yes")

if tableViewCell == "Yes":
   builder("TableViewCellTemplate.h", "Cell.h", "Yes")
   builder("TableViewCellTemplate.m", "Cell.m", "Yes")
   builder("CellAdapterTemplate.h", "CellAdapter.h", "Yes")
...
if collectionViewCell == 'Yes':
   builder("CollectionViewTemplate.h", "View.h", "Yes")
   builder("CollectionViewTemplate.m", "View.m", "Yes")
   builder("CollectionViewCellTemplate.h", "Cell.h", "Yes")
   builder("CollectionViewCellTemplate.m", "Cell.m", "Yes")
   builder("CellAdapterTemplate.h", "CellAdapter.h", "Yes")
